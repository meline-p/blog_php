...
<div id="content" class="container">
	...
	<form action="/inscription" method="POST">
		<div class="mb-3">
			...
			<input required value="<?php echo isset($_POST['surname']) ? htmlspecialchars($_POST['surname']) : ''; ?>" 
			type="surname" class="form-control" id="surname" name="surname" aria-describedby="surname-help">
		</div>
		<div class="mb-3">
			<label for="first_name" class="form-label">Prénom</label>
			<input required value="<?php echo isset($_POST['first_name']) ? htmlspecialchars($_POST['first_name']) : ''; ?>" 
			type="first_name" class="form-control" id="first_name" name="first_name" aria-describedby="surname-help">
		</div>
		<div class="mb-3">
			<label for="last_name" class="form-label">Nom</label>
			<input value="<?php echo isset($_POST['last_name']) ? htmlspecialchars($_POST['last_name']) : ''; ?>" required 
			type="last_name" class="form-control" id="last_name" name="last_name" aria-describedby="surname-help">
		</div>
		<div class="mb-3">
			<label for="email" class="form-label">Email</label>
			<input required value="<?php echo isset($_POST['email']) ? htmlspecialchars($_POST['email']) : ''; ?>" 
